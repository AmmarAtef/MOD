...
namespace MaterialsRequestsWFWebparts.MaterialsRequestDetailsWP
{
    ...
    public class MaterialsRequestDetailsWP : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/MaterialsRequestsWFWebparts/MaterialsRequestDetailsWP/MaterialsRequestDetailsWPUserControl.ascx";
