...
namespace MaterialsRequestsWFWebparts.SecurityMaterialsRequestsWP
{
    ...
    public class SecurityMaterialsRequestsWP : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/MaterialsRequestsWFWebparts/SecurityMaterialsRequestsWP/SecurityMaterialsRequestsWPUserControl.ascx";
