...
namespace MaterialsRequestsWFWebparts.ProtectionMaterialsReportWP
{
    ...
    public class ProtectionMaterialsReportWP : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/MaterialsRequestsWFWebparts/ProtectionMaterialsReportWP/ProtectionMaterialsReportWPUserControl.ascx";
        /// <summary>
        /// Request type 
        /// </summary>
