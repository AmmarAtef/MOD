...
namespace DevicesRequestsWFWebparts.ProtectionDevicesRequestsReportWP
{
    ...
    public class ProtectionDevicesRequestsReportWP : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/DevicesRequestsWFWebparts/ProtectionDevicesRequestsReportWP/ProtectionDevicesRequestsReportWPUserControl.ascx";
