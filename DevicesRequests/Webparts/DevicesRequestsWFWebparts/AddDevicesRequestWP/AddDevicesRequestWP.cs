...
namespace DevicesRequestsWFWebparts.AddDevicesRequestWP
{
    ...
    public class AddDevicesRequestWP : WebPart
    {
        // Visual Studio might automatically update this path when you change the Visual Web Part project item.
        private const string _ascxPath = @"~/_CONTROLTEMPLATES/15/DevicesRequestsWFWebparts/AddDevicesRequestWP/AddDevicesRequestWPUserControl.ascx";
